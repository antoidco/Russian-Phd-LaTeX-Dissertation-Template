...
%	\label{nonshear2}
%\end{equation}
Аналогичным образом ищется асимптотическое решение $u= G\left(\theta, T ,Y\right);~ v= F\left(\theta, T, Y\right)$ для тех же быстрых и медленных переменных, что и для продольных волн. Выражение для фазовой скорости в высшем порядке,
\begin{equation}
...
\begin{figure}[h]
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.8]{fig1t.pdf} & \includegraphics[scale=0.8]{palette.pdf}
		\end{tabular}
...
\begin{figure}
	\begin{center}
		\includegraphics[scale=0.8]{fig2_instead.pdf} 
...
\begin{figure}
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.8]{fig3t.pdf} & \includegraphics[scale=0.8]{palette.pdf}
		\end{tabular}
...
\begin{figure}
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.8]{fig4t.pdf} & \includegraphics[scale=0.8]{palette.pdf}
		\end{tabular}
