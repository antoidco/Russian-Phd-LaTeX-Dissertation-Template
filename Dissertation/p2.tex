...
\begin{figure}[h]
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.7]{fig1t.pdf} & \includegraphics[scale=0.6]{palette.pdf}
		\end{tabular}
...
\begin{figure}
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.6]{fig3t.pdf} & \includegraphics[scale=0.6]{palette.pdf}
		\end{tabular}
...
\begin{figure}
	\begin{center}
		\begin{tabular}{cc}
			\includegraphics[scale=0.6]{fig4t.pdf} & \includegraphics[scale=0.6]{palette.pdf}
		\end{tabular}
